...
#   curl -fsSLo installer.sh https://get.hackr.es/
...
# Usage: export BARCH_HOSTNAME='barch'
# Description: This variable sets the hostname
_hostname="${BARCH_HOSTNAME:-barch}"

# Usage: export BARCH_LOCALE='en'
# Description: This variable sets the locale
# Options: "es", "us"
_locale="${BARCH_LOCALE:-us}"

# Usage: export BARCH_LOGFILE='./barch.log'
# Description: This variable sets the log file
_logfile="${BARCH_LOGFILE:-/var/log/barch.log}"

# Usage: export BARCH_MOUNT='/tmp'
# Description: This variable sets the mount point
_mountpoint="${BARCH_MOUNT:-/mnt}"

# USAGE: export BARCH_PASSWORD='Sup3rStr0ngP45s!'
# Description: This variable sets the main user password
_password="${BARCH_PASSWORD:-hacker}"

# Usage: export BARCH_SUMETHOD='sudo'
# Description: This variable sets the superuser method
# Options: "doas", "sudo"
_sumethod="${BARCH_SUMETHOD:-doas}"

# Usage: export BARCH_TZ='Europe/Madrid'
# Description: This variable sets the timezone
_tz="${BARCH_TZ:-Europe/Madrid}"

# Usage: export BARCH_VERBOSE=1
# Description: This variable enables verbose mode
_verbose="${BARCH_VERBOSE:-0}"

# Usage: export BARCH_USER='hacker'
# Description: This variable sets the main username
_user="${BARCH_USER:-hacker}"
...
install_pkgs_grub() {
    ...
    \log_dbg 'Configuring GRUB...'; \sed -i 's/GRUB_DISTRIBUTOR="Arch"/GRUB_DISTRIBUTOR="Barch"/' "${_mountpoint}/etc/default/grub"; \dbg < "${_mountpoint}/etc/default/grub"
